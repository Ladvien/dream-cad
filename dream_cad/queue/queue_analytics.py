"""Analytics and reporting for queue processing."""
...
class ModelPerformance:
    ...
    def update(self, job: GenerationJob) -> None:
        ...
        # Calculate success rate (safe division)
...
class QueueAnalytics:
    """Analytics engine for queue processing."""
    
    def __init__(
        self,
        job_queue: JobQueue,
        analytics_dir: Path = Path("analytics"),
        gpu_cost_per_hour: float = 0.5,  # Default GPU cost
    ):
    ...
    def analyze_time_series(self) -> Dict[str, Dict[str, int]]:
        """Analyze queue activity over time."""
    ...
    def _get_busiest_hours(
        ...
        """Get busiest hours by job submissions."""
        sorted_hours = sorted(
            time_series.items(),
    ...
    def _get_model_recommendations(
        ...
        for model_name, perf in model_performance.items():
            ...
            elif perf.average_generation_time > 300:  # 5 minutes
                recommendations[model_name] = (
