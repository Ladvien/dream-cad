...
class RegressionThresholds:
    ...
    max_time_increase_percent: float = 20.0  # Max acceptable time increase
    min_quality_decrease_percent: float = 10.0  # Max acceptable quality decrease
    max_vram_increase_gb: float = 2.0  # Max acceptable VRAM increase
    max_failure_rate_increase_percent: float = 5.0  # Max acceptable failure rate increase
    min_samples: int = 3  # Minimum samples needed for comparison
...
class RegressionTester:
    """Test for performance regressions in models."""
    ...
    def test_regression(
        ...
        # Trigger post_init to calculate summary
    ...
    def test_all_models(
        ...
        """Test regression for all models with baselines."""
        results = []
    ...
    def update_baseline_if_improved(
        ...
        # Update if at least 2 metrics improved and none regressed significantly
        improvements = sum([better_time, better_quality, better_memory, better_success])
        
        if improvements >= 2:
            # Test for regression first
