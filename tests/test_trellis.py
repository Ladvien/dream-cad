"""
Tests for TRELLIS model integration.
"""
...
class TestTRELLISCapabilities:
    """Test TRELLIS capabilities and configuration."""
    ...
    def test_capabilities(self):
        ...
        assert caps.min_vram_gb == 8.0  # With optimizations
        assert caps.recommended_vram_gb == 16.0
        assert not caps.supports_batch  # Sequential processing
    ...
    def test_representation_configuration(self):
        """Test representation type configuration."""
        config = ModelConfig(
            model_name="trellis",
            extra_params={
                "representation": "nerf",
...
class TestRepresentationTypes:
    """Test different 3D representation types."""
    
    def test_nerf_representation(self):
        """Test NeRF representation."""
    ...
    def test_gaussian_splatting(self):
        """Test Gaussian splatting representation."""
        ...
        assert gaussian.rotations.shape == (1000, 4)  # Quaternions
...
class TestTRELLISGeneration:
    """Test 3D generation with different representations."""
    ...
    def test_generate_mesh_from_image(self):
        """Test mesh generation from image."""
    ...
    def test_generate_nerf_from_image(self):
        """Test NeRF generation from image."""
    ...
    def test_generate_gaussian_from_image(self):
        """Test Gaussian splatting generation from image."""
        image = Image.new("RGB", (512, 512))
    ...
    def test_view_consistency(self):
        """Test multi-view consistency generation."""
...
class TestSequentialProcessing:
    """Test sequential processing for memory efficiency."""
    ...
    def test_sequential_slat_generation(self):
        """Test sequential SLAT generation."""
        image = Image.new("RGB", (512, 512))
    ...
    def test_memory_efficient_generation(self):
        ...
        assert result.memory_used_gb <= 16.0  # Should be optimized
...
class TestFormatConversion:
    ...
    def test_preserve_intermediate(self):
        """Test preserving intermediate representations."""
        ...
        assert result.success
        # Intermediate SLAT should be preserved
        # (would be in result data in production)


class TestRepresentationSaving:
    """Test saving different 3D representations."""
    ...
    def test_save_gaussian(self):
        """Test Gaussian splatting saving."""
        gaussian = GaussianSplatting(
    ...
    def test_save_mesh_formats(self):
        """Test saving mesh in different formats."""
        mesh_data = {
...
class TestOptimizations:
    ...
    def test_optimized_fork_usage(self):
        """Test optimized fork configuration."""
        config = ModelConfig(
            model_name="trellis",
            extra_params={"use_optimized_fork": True}
        )
    ...
    def test_quality_mode_memory(self):
        """Test memory usage by quality mode."""
...
class TestIntegration:
    ...
    def test_hardware_compatibility(self):
        ...
        # Should work with 8GB (minimum with optimizations)
        assert caps.can_run_on_hardware(8.0)
        
        # Should not work with 6GB
